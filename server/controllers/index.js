...
module.exports.displayAboutPage = (req, res, next) => {
    res.render('content/about', { title: 'About Me', displayName: req.user ? req.user.displayName : ''});
}
...
module.exports.displayContactPage = (req, res, next) => {
    res.render('content/contact', { title: 'Contact Me', displayName: req.user ? req.user.displayName : ''});
}
